...
function Signin() {
	...
	const googleSignIn = async (e: any) => {
		try {
			...
			const employeeDoc = await axios.get(
				env.url + "/employee/" + employee.uid
			);
					...
					<div className="max-w-6xl mx-auto px-4 sm:px-6">
						<div className="pt-10 pb-12 md:pt-20 md:pb-20">
							...
							<div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
								<h1 className="h2 font-extrabold text-accent">
									Welcome back. Signin to manage and view your initiatives!
								</h1>
							</div>
