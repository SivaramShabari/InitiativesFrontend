...
function DropdownProfile({ align }: any) {
	...
	return (
		<div className="relative inline-flex">
			...
			<Transition
				appear={undefined}
				className={`origin-top-right z-10 absolute top-full min-w-44 bg-base-300 border border-base-100 py-1.5 rounded shadow-lg overflow-hidden mt-1 ${
			...
			>
				...
				>
					<div className="pt-0.5 pb-2 px-3 mb-1 border-b border-base-100">
					...
					<ul>
						<li>
							<Link
								className="font-medium text-sm text-primary hover:text-primary-focus flex items-center py-1 px-3"
								to="/account"
								onClick={() => setDropdownOpen(!dropdownOpen)}
							>
								Settings
